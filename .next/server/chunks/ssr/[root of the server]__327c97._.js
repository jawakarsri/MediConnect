...
function AuthProvider({ children }) {
        ...
        try {
            ...
            if (error) {
                ...
                if (error.code === "PGRST116") {
                    ...
                    if (userData?.user) {
                        const { data: newProfile, error: insertError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("profiles").insert({
                            id: userId,
    ...
    async function signUp(email, password, name) {
        try {
            ...
            return {
                data: null,
                error: error instanceof Error ? error : new Error("An error occurred during signup")
            };
        }
    }
...
__turbopack_esm__({
    "cn": (()=>cn),
    "flattenColorPalette": (()=>flattenColorPalette)
});
...
function flattenColorPalette(colors, prefix = "", result = {}) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__327c97._.js.map