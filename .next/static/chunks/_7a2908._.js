(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_7a2908._.js", {
        ...
        try {
            ...
            if (error) {
                ...
                if (error.code === "PGRST116") {
                    ...
                    if (userData?.user) {
                        const { data: newProfile, error: insertError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("profiles").insert({
                            id: userId,
...
_s(AuthProvider, "uiUBMxDQ/u2F6lOINCwvfAYSidE=");
_c = AuthProvider;
function useAuth() {
    _s1();
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/components/ui/use-toast.ts [app-client] (ecmascript)");
;
var _s = __turbopack_refresh__.signature();
"use client";
;
...
//# sourceMappingURL=_7a2908._.js.map